# Create S4 method 'sequestSetup'
if (!isGeneric("sequestSetup"))
setGeneric("sequestSetup", function(element, period="Period", ptSA="list", modulenum="numeric", elementnum="numeric",
										firstPeriod="numeric", dset="list") standardGeneric("sequestSetup"))
setMethod("sequestSetup", "PPgenBMS",
    function(
