...
EnvGenVar$Timesteps 			<- list(  # divided here into 12 equal timesteps

			 UpdateEnv_01  = list(
           calday    = dayFromDate(day=1,month=10)  # end of timestep 1
          ,actionsN = NULL
          ,actions   = list(
					            printState = list(
                    ...
                    ,update.environments = list(actionMethod = EnvGenVar$FunctionsList$UpdateEnv$actionMethod
                                ...
                                ) # end update environment of general variable
      ) # end timesteps list
