...
Files.Krill = list(PlotName      = "Krill"
                  ...
                  ,PlotLineWidth = 3
                  ,Polygons      = c(1)  
                  ,PlotRelPolys   = c(1:15)   # relative positions of Polygons to plot
...
Files.Seal = list(PlotName      = "Seals"
                 ...
                 ,PlotLineType  = 1
                 ,PlotLineWidth = 1
                 ,Polygons         = c(3,4,7,10,11,12,14,15)
                 ,PlotRelPolys     = c(1,2,3,4,5,6,7,8)   # relative positions of Polygons to plot
...
Files.PengA3 = list(PlotName      = "PenguinsA3"
                   ...
                   ,PlotLineType  = 1
                   ,PlotLineWidth = 1
                   ,Polygons         = c(3,4,5,7,10,12)
                   ,PlotRelPolys  = c(1:6)   # relative positions of Polygons to plot
...
Files.PengA4 = list(PlotName      = "PenguinsA4"
                   ...
                   ,PlotLineWidth = 1
                   ,Polygons         = c(2,6,15)
                   ,PlotRelPolys  = c(1,2,3)   # relative positions of Polygons to plot
...
Files.FishA2F1 = list(PlotName    = "FishA2F1"
                   ...
                   ,PlotLineWidth = 1
                   ,Polygons         = c(9,13)
                   ,PlotRelPolys  = c(1,2)   # relative positions of Polygons to plot
...
Files.FishA2F3 = list(PlotName    = "FishA2F3"
                   ...
                   ,PlotLineType  = 3
                   ,PlotLineWidth = 1
                   ,Polygons         = c(1,7,10,11)
                   ,PlotRelPolys  = c(1,2,3,4)   # relative positions of Polygons to plot
...
Files.FishA3F1 = list(PlotName    = "FishA3F1"
                   ...
                   ,PlotLineType  = 4
                   ,PlotLineWidth = 1
                   ,Polygons         = c(2,3,4,5,6,8,12)
                   ,PlotRelPolys  = c(1,2,3,4,5,6,7)   # relative positions of Polygons to plot
...
for (Ne in 1:Nelmnts){
  ...
  Data<-Data[Data[,2]>=FirstYear,c(1:3,(PlotRelPolys+3))]
  DataCols<-ncol(Data)
