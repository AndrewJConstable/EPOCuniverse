...
#                 - required inputs are
#                    Config$TrialsN
#                    Config$Trial$YearStart
#                    Config$Trial$YearEnd
#                    Config$Polygon$Polygon.Names
#                    Config$Trial$RootDir
#   ############################################################################
# Extend base class
...
# Description:        Initialise Predator at the beginning of a trial
...
setMethod("initialiseTrial", signature(element="Fishery", universe="Universe"),
